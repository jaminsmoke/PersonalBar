 ...
 * Adaptado de `PersonalComander/.../ui/Voz.kt`: misma estrategia de timeouts RMS y
 * silencio permisivo; aquí se usa para cambiar el estado de una orden de cola, no para
 * pedir productos.
 */
...
fun mensajeErrorVoz(context: Context?, error: Int): String {
