...
- Version target: **v0.4** (latest GitHub Release is **v0.3** — `gh release list`)
...
**Version always > latest release**: consult `gh release list`, pick the next one (currently **v0.4**).
...
# Create item
$KANBAN create --title "..." --tipo Feature --area Android --priority Alta --version "v0.4"
...
| Versión | SingleSelect | Sin asignar, v0.1, v0.2, v0.3, v0.4, … |
